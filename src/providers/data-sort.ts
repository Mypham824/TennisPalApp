...
import { ArraySort } from '../providers/app-data';
...
export class DataSort {
 ...
 constructor() { }
    ...
    */
    ...
    removeItems<T>(array: Array<T>, predicate: ArraySort<T>) {
        lodash.remove(array, predicate);
    }

    includesItem<T>(array: Array<T>, predicate: ArraySort<T>) {
    ...
    */
    setItem<T>(array: Array<T>, predicate: ArraySort<T>, item: T) {
